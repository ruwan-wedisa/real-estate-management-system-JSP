                ...
                <div class="col-sm-6 login">
                    ...
                    <form class="" role="form" name="form2" action="loginCodeJsp.jsp" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail2" name="loginUN" placeholder="Enter userName" required>
                        </div>
                        <div class="form-group">
                            <label class="sr-only" for="exampleInputPassword2">Password</label>
                            <input type="password" class="form-control" id="exampleInputPassword2" name="loginPW" placeholder="Password" required>
                        </div>
                        <div class="checkbox">
                            <label>
