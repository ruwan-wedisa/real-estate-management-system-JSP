    ...
    <body>
        <%
            ...
            try {
                ...
                String query = "INSERT INTO login(userName,password,activated,userCategory) VALUES('" + username + "','" + password + "','1','2')";
                ...
                if (a > 0) {
                    ...
                    String query2 = "INSERT INTO customer(id,customerName,address,NIC,telNo,email) VALUES('" + id + "','" + name + "','" + address + "','" + nic + "','" + tel + "','" + email + "')";
